                            ...
                            <div class="card-body card-form p-4">
                                ...
                                <div class="row">
                                    ...
                                    <div class="col-md-6  mb-4">
                                        ...
                                        <input type="number" min="1" placeholder="Vacancy"
                                            value="{{ $job->vacancy }}" id="vacancy" name="vacancy" class="form-control">
                                        <p></p>
                                    </div>
                                </div>
                                ...
                                <div class="row">
                                    <div class="mb-4 col-md-6">
                                        ...
                                        <input type="text" placeholder="Salary" value="{{ $job->salary }}"
                                ...
                                <div class="mb-4">
                                    ...
                                    <textarea class="form-control" value="" name="description" id="description" cols="5" rows="5"
                                ...
                                <div class="mb-4">
                                    ...
                                    <input type="text" class="form-control" name="qualifications" id="qualifications"
                                        placeholder="Qualifications" value="{{ $job->responsibility }}">
                                </div>
                                <div class="mb-4">
...
@section('customJs')
    <script type="text/javascript">
        $("#updatejobForm").submit(function(e) {
            ...
            try {
                $.ajax({
                    url: '{{ route('account.updateJob', $job->id) }}', // Update the URL with the correct endpoint
                    method: 'PUT',
                    dataType: 'json',
