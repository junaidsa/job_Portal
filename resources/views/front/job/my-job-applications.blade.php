                                        ...
                                        @if ($jobApplications->isNotEmpty())
                                            @foreach ($jobApplications as $jobApplication)
                                                <tr class="active">
                                                    ...
                                                    <td>{{$jobApplication->job->appications->count()}} Applications</td>
                                                    <td>
                                                    ...
                                                    <td>
                                                        <div class="action-dots float-end">
                                                            ...
                                                            <ul class="dropdown-menu dropdown-menu-end">
                                                                <li>
                                                                     <a class="dropdown-item" href="{{route('jobDetails',$jobApplication->job_id)}}"> <i
                                                                             class="fa fa-eye" aria-hidden="true"></i>
                                                                     View</a>
                                                                </li>
                                                                <li>
                                                                     <a class="dropdown-item"href="#" onclick="deleteJob({{$jobApplication->id}})"> <i
    ...
    <script type="text/javascript">
        function deleteJob(id) {
            if (confirm('Are you sure you want to delete this record?')) {
                $.ajax({
                    url: "{{ route('account.deletetAppliedjob') }}",
                    type: 'post',
                    data:{id:id},
                    dataType: 'json',
